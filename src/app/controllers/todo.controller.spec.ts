...
describe('ApiController', () => {
    ...
    beforeEach(() => (controller = createController(TodoController)))
    ...
    describe('has a "getTodos" method that', () => {
        ...
        it('should handle requests at GET /.', () => {
            ...
            strictEqual(getHttpMethod(TodoController, 'getTodos'), 'GET')
            // Throw an error and make the test fail if the path of `getTodos` is not /todos.
            strictEqual(getPath(TodoController, 'getTodos'), '/todos')
        })
        ...
        it('should return an HttpResponseOK.', async () => {
            ...
            ok(
                Array.isArray(body),
                'The body of the response should be an array.'
            )
